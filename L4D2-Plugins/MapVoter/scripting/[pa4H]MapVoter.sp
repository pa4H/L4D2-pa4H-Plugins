...
public void OnPluginStart()
{
	...
	timeEndVote = CreateConVar("timeToEndVote", "18.0", "", FCVAR_CHEAT);
...
void getMapsList() // Формирование списка карт
{
	...
	// Удаляем 6 карт из 14-1 возможных (14 минус 1)
	for (int i = 0; i < 6; i++)
	{
		newMaps.Erase(GetRandomInt(0, newMaps.Length - 1));
	}
	newMaps.Sort(Sort_Descending, Sort_Integer); // Инвертируем массив
}
